...
import com.comze_instancelabs.zerog.gravitygun.Attributes.Attribute;
import com.comze_instancelabs.zerog.gravitygun.Attributes.AttributeType;
import com.comze_instancelabs.zerog.gravitygun.Attributes.Operation;
...
public class AttributeStorage {
	...
	public void setData(String data) {
		...
		if (current == null) {
			attributes.add(Attribute.newBuilder().name(data).amount(0)
					.uuid(uniqueKey).operation(Operation.ADD_NUMBER)
					.type(AttributeType.GENERIC_ATTACK_DAMAGE).build());
		} else {
