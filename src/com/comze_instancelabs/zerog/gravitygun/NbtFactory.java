...
public class NbtFactory {
	...
	public final class NbtCompound extends ConvertedMap {
		 ...
		 * <p>
		 * Every element of the path (except the end) are assumed to be compounds. The retrieval operation will be cancelled if any of them are
		 * missing.
		 * 
		 * @param path
		 *            - path to the entry.
	...
	/**
	 * Construct a wrapper for an NBT tag stored (in memory) in an item stack. This is where auxillary data such as enchanting, name and lore is
	 * stored. It does not include items material, damage value or count.
	 * <p>
	 ...
	 * @param clazz
	 *            - an optional class to start with, or NULL to deduce it from instance.
	 * @param fieldName
	 *            - the field name.
